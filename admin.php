  ...
  <ul class="navbar-nav align-items-center right-nav-link">
    ...
    <li class="nav-item language">
      ...
      <ul class="dropdown-menu dropdown-menu-right">
          ...
          <li class="dropdown-item"> <i class="flag-icon flag-icon-fr mr-2"></i> Bangla</li>
      ...
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="image/profileimg.jpg" alt="user avatar"></div>
            <div class="media-body">
            <h6 class="mt-2 user-title">Md Nazmul Islam</h6>
            <p class="user-subtitle">nazmulislamsoftdev@gmail.com</p>
            </div>
           </div>
          </a>
        </li>
